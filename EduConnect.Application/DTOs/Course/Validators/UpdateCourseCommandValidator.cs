...
public sealed class UpdateCourseCommandValidator : AbstractValidator<CourseForUpdateDto>
{
    private readonly IStringLocalizer<UpdateCourseCommandValidator> localizer;
