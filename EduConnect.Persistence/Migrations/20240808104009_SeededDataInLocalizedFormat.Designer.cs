...
namespace EduConnect.Persistence.Migrations
{
    ...
    [Migration("20240808104009_SeededDataInLocalizedFormat")]
    partial class SeededDataInLocalizedFormat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduConnect.Domain.Entities.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EduConnect.Domain.Entities.Instructor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EduConnect.Domain.Entities.InstructorCourse", b =>
                {
            ...
            modelBuilder.Entity("EduConnect.Domain.Entities.Topic", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EduConnect.Domain.Entities.Course", b =>
                {
                    b.HasOne("EduConnect.Domain.Entities.Topic", "Topic")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("EduConnect.Domain.Entities.Department", b =>
                {
                    b.HasOne("EduConnect.Domain.Entities.Instructor", "InstructorManager")
                        .WithOne()
                        .HasForeignKey("EduConnect.Domain.Entities.Department", "InstructorManagerId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("EduConnect.Domain.Entities.Instructor", b =>
                {
                    b.HasOne("EduConnect.Domain.Entities.Department", "Department")
            ...
            modelBuilder.Entity("EduConnect.Domain.Entities.InstructorCourse", b =>
                {
                    ...
                    b.HasOne("EduConnect.Domain.Entities.Instructor", "Instructor")
                        .WithMany("InstructorCourses")
